...
#include "message.h"
struct WS_PlayerTouch;
struct WS_PlayerTouchReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "WS_PlayerTouchReq";
    static constexpr int the_message_id = WS_PLAYER_TOUCH;
    static constexpr const char *the_message_name = "WS_PLAYER_TOUCH";
    typedef WS_PlayerTouch the_message_type;
    
    WS_PlayerTouchReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct WS_PlayerTouchRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "WS_PlayerTouchRsp";
    static constexpr int the_message_id = WS_PLAYER_TOUCH;
    static constexpr const char *the_message_name = "WS_PLAYER_TOUCH";
    typedef WS_PlayerTouch the_message_type;
    
    WS_PlayerTouchRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct WS_PlayerTouch {
    static constexpr const char *the_class_name = "WS_PlayerTouch";
    static constexpr int the_message_id = WS_PLAYER_TOUCH;
    static constexpr const char *the_message_name = "WS_PLAYER_TOUCH";
    typedef WS_PlayerTouchReq request_type;
    typedef WS_PlayerTouchRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    WS_PlayerTouch(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
