...
#include "message.h"
struct WS_ScoreRankingList;
struct WS_ScoreRankingListReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "WS_ScoreRankingListReq";
    static constexpr int the_message_id = WS_SCORE_RANKING_LIST;
    static constexpr const char *the_message_name = "WS_SCORE_RANKING_LIST";
    typedef WS_ScoreRankingList the_message_type;
    SSCC_UINT16 begin;
    SSCC_UINT16 end;
    
    WS_ScoreRankingListReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct WS_ScoreRankingListRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "WS_ScoreRankingListRsp";
    static constexpr int the_message_id = WS_SCORE_RANKING_LIST;
    static constexpr const char *the_message_name = "WS_SCORE_RANKING_LIST";
    typedef WS_ScoreRankingList the_message_type;
    SSCC_UINT32 self;
    SSCC_VECTOR(G_ScoreRankingItem) list;
    
    WS_ScoreRankingListRsp(SSCC_ALLOCATOR_PARAM_DECL)
    : SSCC_RESPONSE_BASE(SSCC_ALLOCATOR_PARAM),
      self(),
      list(SSCC_VECTOR(G_ScoreRankingItem)::allocator_type(SSCC_ALLOCATOR_PARAM))
    { }
...
struct WS_ScoreRankingList {
    static constexpr const char *the_class_name = "WS_ScoreRankingList";
    static constexpr int the_message_id = WS_SCORE_RANKING_LIST;
    static constexpr const char *the_message_name = "WS_SCORE_RANKING_LIST";
    typedef WS_ScoreRankingListReq request_type;
    typedef WS_ScoreRankingListRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    WS_ScoreRankingList(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
