...
#include "message.h"
struct WS_Logout;
struct WS_LogoutReq : INotify {
    static constexpr const char *the_class_name = "WS_LogoutReq";
    static constexpr int the_message_id = WS_LOGOUT;
    static constexpr const char *the_message_name = "WS_LOGOUT";
    typedef WS_Logout the_message_type;
    SSCC_UINT32 uid;
    
    WS_LogoutReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct WS_Logout {
    static constexpr const char *the_class_name = "WS_Logout";
    static constexpr int the_message_id = WS_LOGOUT;
    static constexpr const char *the_message_name = "WS_LOGOUT";
    typedef WS_LogoutReq request_type;
    typedef void response_type;
    
    SSCC_POINTER(request_type) req;
    
    WS_Logout(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)) { }
};
