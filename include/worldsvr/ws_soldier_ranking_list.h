...
#include "message.h"
struct WS_SoldierRankingList;
struct WS_SoldierRankingListReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "WS_SoldierRankingListReq";
    static constexpr int the_message_id = WS_SOLDIER_RANKING_LIST;
    static constexpr const char *the_message_name = "WS_SOLDIER_RANKING_LIST";
    typedef WS_SoldierRankingList the_message_type;
    SSCC_UINT16 begin;
    SSCC_UINT16 end;
    
    WS_SoldierRankingListReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct WS_SoldierRankingListRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "WS_SoldierRankingListRsp";
    static constexpr int the_message_id = WS_SOLDIER_RANKING_LIST;
    static constexpr const char *the_message_name = "WS_SOLDIER_RANKING_LIST";
    typedef WS_SoldierRankingList the_message_type;
    SSCC_UINT32 self;
    ...
    WS_SoldierRankingListRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct WS_SoldierRankingList {
    static constexpr const char *the_class_name = "WS_SoldierRankingList";
    static constexpr int the_message_id = WS_SOLDIER_RANKING_LIST;
    static constexpr const char *the_message_name = "WS_SOLDIER_RANKING_LIST";
    typedef WS_SoldierRankingListReq request_type;
    typedef WS_SoldierRankingListRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    WS_SoldierRankingList(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
