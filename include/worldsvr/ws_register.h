...
#include "message.h"
struct WS_Register;
struct WS_RegisterReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "WS_RegisterReq";
    static constexpr int the_message_id = WS_REGISTER;
    static constexpr const char *the_message_name = "WS_REGISTER";
    typedef WS_Register the_message_type;
    SSCC_STRING user;
    SSCC_STRING passwd;
    ...
    WS_RegisterReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct WS_RegisterRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "WS_RegisterRsp";
    static constexpr int the_message_id = WS_REGISTER;
    static constexpr const char *the_message_name = "WS_REGISTER";
    typedef WS_Register the_message_type;
    
    WS_RegisterRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct WS_Register {
    static constexpr const char *the_class_name = "WS_Register";
    static constexpr int the_message_id = WS_REGISTER;
    static constexpr const char *the_message_name = "WS_REGISTER";
    typedef WS_RegisterReq request_type;
    typedef WS_RegisterRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    WS_Register(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
