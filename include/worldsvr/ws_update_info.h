...
#include "message.h"
struct WS_UpdateLevel;
struct WS_UpdateLevelReq : INotify {
    static constexpr const char *the_class_name = "WS_UpdateLevelReq";
    static constexpr int the_message_id = WS_UPDATE_LEVEL;
    static constexpr const char *the_message_name = "WS_UPDATE_LEVEL";
    typedef WS_UpdateLevel the_message_type;
    SSCC_UINT32 uid;
    SSCC_UINT16 level;
    
    WS_UpdateLevelReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct WS_UpdateLevel {
    static constexpr const char *the_class_name = "WS_UpdateLevel";
    static constexpr int the_message_id = WS_UPDATE_LEVEL;
    static constexpr const char *the_message_name = "WS_UPDATE_LEVEL";
    typedef WS_UpdateLevelReq request_type;
    typedef void response_type;
    
    SSCC_POINTER(request_type) req;
    
    WS_UpdateLevel(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)) { }
};
struct WS_UpdateVip;
struct WS_UpdateVipReq : INotify {
    static constexpr const char *the_class_name = "WS_UpdateVipReq";
    static constexpr int the_message_id = WS_UPDATE_VIP;
    static constexpr const char *the_message_name = "WS_UPDATE_VIP";
    typedef WS_UpdateVip the_message_type;
    SSCC_UINT32 uid;
    SSCC_UINT8 vip;
    
    WS_UpdateVipReq(SSCC_ALLOCATOR_PARAM_DECL)
    : INotify(SSCC_ALLOCATOR_PARAM),
      uid(),
      vip()
    { }
...
struct WS_UpdateVip {
    static constexpr const char *the_class_name = "WS_UpdateVip";
    static constexpr int the_message_id = WS_UPDATE_VIP;
    static constexpr const char *the_message_name = "WS_UPDATE_VIP";
    typedef WS_UpdateVipReq request_type;
    typedef void response_type;
    
    SSCC_POINTER(request_type) req;
    
    WS_UpdateVip(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)) { }
};
struct WS_UpdateSide;
struct WS_UpdateSideReq : INotify {
    static constexpr const char *the_class_name = "WS_UpdateSideReq";
    static constexpr int the_message_id = WS_UPDATE_SIDE;
    static constexpr const char *the_message_name = "WS_UPDATE_SIDE";
    typedef WS_UpdateSide the_message_type;
    SSCC_UINT32 uid;
    SSCC_UINT8 side;
    
    WS_UpdateSideReq(SSCC_ALLOCATOR_PARAM_DECL)
    : INotify(SSCC_ALLOCATOR_PARAM),
      uid(),
      side()
    { }
...
struct WS_UpdateSide {
    static constexpr const char *the_class_name = "WS_UpdateSide";
    static constexpr int the_message_id = WS_UPDATE_SIDE;
    static constexpr const char *the_message_name = "WS_UPDATE_SIDE";
    typedef WS_UpdateSideReq request_type;
    typedef void response_type;
    
    SSCC_POINTER(request_type) req;
    
    WS_UpdateSide(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)) { }
};
struct WS_UpdateAppearance;
struct WS_UpdateAppearanceReq : INotify {
    static constexpr const char *the_class_name = "WS_UpdateAppearanceReq";
    static constexpr int the_message_id = WS_UPDATE_APPEARANCE;
    static constexpr const char *the_message_name = "WS_UPDATE_APPEARANCE";
    typedef WS_UpdateAppearance the_message_type;
    SSCC_UINT32 uid;
    SSCC_UINT32 appearance;
    
    WS_UpdateAppearanceReq(SSCC_ALLOCATOR_PARAM_DECL)
    : INotify(SSCC_ALLOCATOR_PARAM),
      uid(),
      appearance()
    { }
...
struct WS_UpdateAppearance {
    static constexpr const char *the_class_name = "WS_UpdateAppearance";
    static constexpr int the_message_id = WS_UPDATE_APPEARANCE;
    static constexpr const char *the_message_name = "WS_UPDATE_APPEARANCE";
    typedef WS_UpdateAppearanceReq request_type;
    typedef void response_type;
    
    SSCC_POINTER(request_type) req;
    
    WS_UpdateAppearance(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)) { }
};
