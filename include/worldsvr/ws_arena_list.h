...
#include "message.h"
struct WS_ArenaList;
struct WS_ArenaListReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "WS_ArenaListReq";
    static constexpr int the_message_id = WS_ARENA_LIST;
    static constexpr const char *the_message_name = "WS_ARENA_LIST";
    typedef WS_ArenaList the_message_type;
    
    WS_ArenaListReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct WS_ArenaListRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "WS_ArenaListRsp";
    static constexpr int the_message_id = WS_ARENA_LIST;
    static constexpr const char *the_message_name = "WS_ARENA_LIST";
    typedef WS_ArenaList the_message_type;
    SSCC_UINT32 self;
    ...
    WS_ArenaListRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct WS_ArenaList {
    static constexpr const char *the_class_name = "WS_ArenaList";
    static constexpr int the_message_id = WS_ARENA_LIST;
    static constexpr const char *the_message_name = "WS_ARENA_LIST";
    typedef WS_ArenaListReq request_type;
    typedef WS_ArenaListRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    WS_ArenaList(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
