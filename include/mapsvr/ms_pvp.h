...
#include "message.h"
struct MS_Pvp;
struct MS_PvpReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "MS_PvpReq";
    static constexpr int the_message_id = MS_PVP;
    static constexpr const char *the_message_name = "MS_PVP";
    typedef MS_Pvp the_message_type;
    
    MS_PvpReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct MS_PvpRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "MS_PvpRsp";
    static constexpr int the_message_id = MS_PVP;
    static constexpr const char *the_message_name = "MS_PVP";
    typedef MS_Pvp the_message_type;
    
    MS_PvpRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct MS_Pvp {
    static constexpr const char *the_class_name = "MS_Pvp";
    static constexpr int the_message_id = MS_PVP;
    static constexpr const char *the_message_name = "MS_PVP";
    typedef MS_PvpReq request_type;
    typedef MS_PvpRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    MS_Pvp(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
