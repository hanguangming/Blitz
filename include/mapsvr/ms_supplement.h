...
#include "message.h"
struct MS_Supplement;
struct MS_SupplementReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "MS_SupplementReq";
    static constexpr int the_message_id = MS_SUPPLEMENT;
    static constexpr const char *the_message_name = "MS_SUPPLEMENT";
    typedef MS_Supplement the_message_type;
    G_FightCorps corps;
    
    MS_SupplementReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct MS_SupplementRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "MS_SupplementRsp";
    static constexpr int the_message_id = MS_SUPPLEMENT;
    static constexpr const char *the_message_name = "MS_SUPPLEMENT";
    typedef MS_Supplement the_message_type;
    SSCC_UINT32 people;
    
    MS_SupplementRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct MS_Supplement {
    static constexpr const char *the_class_name = "MS_Supplement";
    static constexpr int the_message_id = MS_SUPPLEMENT;
    static constexpr const char *the_message_name = "MS_SUPPLEMENT";
    typedef MS_SupplementReq request_type;
    typedef MS_SupplementRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    MS_Supplement(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
