...
#include "message.h"
struct MS_Subscribe;
struct MS_SubscribeReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "MS_SubscribeReq";
    static constexpr int the_message_id = MS_SUBSCRIBE;
    static constexpr const char *the_message_name = "MS_SUBSCRIBE";
    typedef MS_Subscribe the_message_type;
    SSCC_UINT32 city;
    
    MS_SubscribeReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct MS_SubscribeRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "MS_SubscribeRsp";
    static constexpr int the_message_id = MS_SUBSCRIBE;
    static constexpr const char *the_message_name = "MS_SUBSCRIBE";
    typedef MS_Subscribe the_message_type;
    
    MS_SubscribeRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct MS_Subscribe {
    static constexpr const char *the_class_name = "MS_Subscribe";
    static constexpr int the_message_id = MS_SUBSCRIBE;
    static constexpr const char *the_message_name = "MS_SUBSCRIBE";
    typedef MS_SubscribeReq request_type;
    typedef MS_SubscribeRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    MS_Subscribe(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
