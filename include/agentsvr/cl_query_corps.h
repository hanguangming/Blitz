...
#include "message.h"
struct CL_QueryCorps;
struct CL_QueryCorpsReq : INotify {
    static constexpr const char *the_class_name = "CL_QueryCorpsReq";
    static constexpr int the_message_id = CL_QUERY_CORPS;
    static constexpr const char *the_message_name = "CL_QUERY_CORPS";
    typedef CL_QueryCorps the_message_type;
    
    CL_QueryCorpsReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_QueryCorpsRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_QueryCorpsRsp";
    static constexpr int the_message_id = CL_QUERY_CORPS;
    static constexpr const char *the_message_name = "CL_QUERY_CORPS";
    typedef CL_QueryCorps the_message_type;
    G_FightCorps corps;
    
    CL_QueryCorpsRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_QueryCorps {
    static constexpr const char *the_class_name = "CL_QueryCorps";
    static constexpr int the_message_id = CL_QUERY_CORPS;
    static constexpr const char *the_message_name = "CL_QUERY_CORPS";
    typedef CL_QueryCorpsReq request_type;
    typedef CL_QueryCorpsRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_QueryCorps(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
