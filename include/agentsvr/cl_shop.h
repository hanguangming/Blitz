...
#include "message.h"
struct CL_ShopBuy;
struct CL_ShopBuyReq : ISerial {
    static constexpr const char *the_class_name = "CL_ShopBuyReq";
    static constexpr int the_message_id = CL_SHOP_BUY;
    static constexpr const char *the_message_name = "CL_SHOP_BUY";
    typedef CL_ShopBuy the_message_type;
    SSCC_UINT32 id;
    SSCC_UINT32 shopid;
    SSCC_UINT32 count;
    
    CL_ShopBuyReq(SSCC_ALLOCATOR_PARAM_DECL)
    ...
    void SSCC_DUMP_FUNC(unsigned sscc_indent SSCC_DUMP_PARAM_DECL) override {
        ...
        SSCC_PRINT_INDENT(sscc_indent);
        SSCC_PRINT("shopid = ");
        SSCC_PRINT("%u(0x%x)", (unsigned)this->shopid, (unsigned)this->shopid);
        SSCC_PRINT(",\n");
        SSCC_PRINT_INDENT(sscc_indent);
        SSCC_PRINT("count = ");
    ...
    void SSCC_TOLUA_FUNC(lua_State *sscc_L, int sscc_index) override {
        ...
        lua_pushlstring(sscc_L, "shopid", 6);
        lua_pushinteger(sscc_L, (lua_Integer)this->shopid);
        lua_settable(sscc_L, sscc_index);
    ...
    bool SSCC_FROMLUA_FUNC(lua_State *sscc_L, int sscc_index SSCC_FROMLUA_PARAM_DECL) override {
        ...
        if (!lua_isnil(sscc_L, -1)) {
            do {
                int isnum;
                this->shopid = lua_tointegerx(sscc_L, -1, &isnum);
                if (!isnum) {
                    goto sscc_exit;
                }
            } while (0);
...
struct CL_ShopBuyRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_ShopBuyRsp";
    static constexpr int the_message_id = CL_SHOP_BUY;
    static constexpr const char *the_message_name = "CL_SHOP_BUY";
    typedef CL_ShopBuy the_message_type;
    
    CL_ShopBuyRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_ShopBuy {
    static constexpr const char *the_class_name = "CL_ShopBuy";
    static constexpr int the_message_id = CL_SHOP_BUY;
    static constexpr const char *the_message_name = "CL_SHOP_BUY";
    typedef CL_ShopBuyReq request_type;
    typedef CL_ShopBuyRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_ShopBuy(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
