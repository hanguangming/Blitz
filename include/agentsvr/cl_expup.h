...
#include "message.h"
struct CL_ExpUp;
struct CL_ExpUpReq : INotify {
    static constexpr const char *the_class_name = "CL_ExpUpReq";
    static constexpr int the_message_id = CL_EXP_UP;
    static constexpr const char *the_message_name = "CL_EXP_UP";
    typedef CL_ExpUp the_message_type;
    SSCC_UINT32 sid;
    SSCC_UINT32 count;
    
    CL_ExpUpReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_ExpUpRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_ExpUpRsp";
    static constexpr int the_message_id = CL_EXP_UP;
    static constexpr const char *the_message_name = "CL_EXP_UP";
    typedef CL_ExpUp the_message_type;
    
    CL_ExpUpRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_ExpUp {
    static constexpr const char *the_class_name = "CL_ExpUp";
    static constexpr int the_message_id = CL_EXP_UP;
    static constexpr const char *the_message_name = "CL_EXP_UP";
    typedef CL_ExpUpReq request_type;
    typedef CL_ExpUpRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_ExpUp(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
