...
#include "message.h"
struct CL_Sell;
struct CL_SellReq : INotify {
    static constexpr const char *the_class_name = "CL_SellReq";
    static constexpr int the_message_id = CL_SELL;
    static constexpr const char *the_message_name = "CL_SELL";
    typedef CL_Sell the_message_type;
    SSCC_UINT32 item_id;
    
    CL_SellReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_SellRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_SellRsp";
    static constexpr int the_message_id = CL_SELL;
    static constexpr const char *the_message_name = "CL_SELL";
    typedef CL_Sell the_message_type;
    
    CL_SellRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_Sell {
    static constexpr const char *the_class_name = "CL_Sell";
    static constexpr int the_message_id = CL_SELL;
    static constexpr const char *the_message_name = "CL_SELL";
    typedef CL_SellReq request_type;
    typedef CL_SellRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_Sell(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
