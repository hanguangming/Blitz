...
#include "message.h"
struct CL_ArenaRankingList;
struct CL_ArenaRankingListReq : INotify {
    static constexpr const char *the_class_name = "CL_ArenaRankingListReq";
    static constexpr int the_message_id = CL_ARENA_RANKING_LIST;
    static constexpr const char *the_message_name = "CL_ARENA_RANKING_LIST";
    typedef CL_ArenaRankingList the_message_type;
    
    CL_ArenaRankingListReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_ArenaRankingListRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_ArenaRankingListRsp";
    static constexpr int the_message_id = CL_ARENA_RANKING_LIST;
    static constexpr const char *the_message_name = "CL_ARENA_RANKING_LIST";
    typedef CL_ArenaRankingList the_message_type;
    SSCC_VECTOR(G_ArenaRankingItem) list;
    
    CL_ArenaRankingListRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_ArenaRankingList {
    static constexpr const char *the_class_name = "CL_ArenaRankingList";
    static constexpr int the_message_id = CL_ARENA_RANKING_LIST;
    static constexpr const char *the_message_name = "CL_ARENA_RANKING_LIST";
    typedef CL_ArenaRankingListReq request_type;
    typedef CL_ArenaRankingListRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_ArenaRankingList(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
