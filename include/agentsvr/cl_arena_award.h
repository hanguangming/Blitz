...
#include "message.h"
struct CL_ArenaAward;
struct CL_ArenaAwardReq : INotify {
    static constexpr const char *the_class_name = "CL_ArenaAwardReq";
    static constexpr int the_message_id = CL_ARENA_AWARD;
    static constexpr const char *the_message_name = "CL_ARENA_AWARD";
    typedef CL_ArenaAward the_message_type;
    
    CL_ArenaAwardReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_ArenaAwardRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_ArenaAwardRsp";
    static constexpr int the_message_id = CL_ARENA_AWARD;
    static constexpr const char *the_message_name = "CL_ARENA_AWARD";
    typedef CL_ArenaAward the_message_type;
    
    CL_ArenaAwardRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_ArenaAward {
    static constexpr const char *the_class_name = "CL_ArenaAward";
    static constexpr int the_message_id = CL_ARENA_AWARD;
    static constexpr const char *the_message_name = "CL_ARENA_AWARD";
    typedef CL_ArenaAwardReq request_type;
    typedef CL_ArenaAwardRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_ArenaAward(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
