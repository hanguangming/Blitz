...
#include "message.h"
struct CL_ScoreRankingList;
struct CL_ScoreRankingListReq : INotify {
    static constexpr const char *the_class_name = "CL_ScoreRankingListReq";
    static constexpr int the_message_id = CL_SCORE_RANKING_LIST;
    static constexpr const char *the_message_name = "CL_SCORE_RANKING_LIST";
    typedef CL_ScoreRankingList the_message_type;
    SSCC_UINT16 begin;
    SSCC_UINT16 end;
    
    CL_ScoreRankingListReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_ScoreRankingListRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_ScoreRankingListRsp";
    static constexpr int the_message_id = CL_SCORE_RANKING_LIST;
    static constexpr const char *the_message_name = "CL_SCORE_RANKING_LIST";
    typedef CL_ScoreRankingList the_message_type;
    SSCC_UINT32 self;
    ...
    CL_ScoreRankingListRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_ScoreRankingList {
    static constexpr const char *the_class_name = "CL_ScoreRankingList";
    static constexpr int the_message_id = CL_SCORE_RANKING_LIST;
    static constexpr const char *the_message_name = "CL_SCORE_RANKING_LIST";
    typedef CL_ScoreRankingListReq request_type;
    typedef CL_ScoreRankingListRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_ScoreRankingList(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
