...
#include "message.h"
struct CL_Appearance;
struct CL_AppearanceReq : INotify {
    static constexpr const char *the_class_name = "CL_AppearanceReq";
    static constexpr int the_message_id = CL_APPEARANCE;
    static constexpr const char *the_message_name = "CL_APPEARANCE";
    typedef CL_Appearance the_message_type;
    SSCC_UINT32 appearance_id;
    
    CL_AppearanceReq(SSCC_ALLOCATOR_PARAM_DECL)
    ...
    bool SSCC_SERIAL_FUNC(SSCC_SERIAL_PARAM_DECL) const override {
        ...
        SSCC_WRITE_UINT32(this->appearance_id);
        return true;
    }
    ...
    bool SSCC_UNSERIAL_FUNC(SSCC_UNSERIAL_PARAM_DECL) override {
        ...
        SSCC_READ_UINT32(this->appearance_id);
        return true;
    }
    ...
    void SSCC_DUMP_FUNC(unsigned sscc_indent SSCC_DUMP_PARAM_DECL) override {
        ...
        SSCC_PRINT("appearance_id = ");
        SSCC_PRINT("%u(0x%x)", (unsigned)this->appearance_id, (unsigned)this->appearance_id);
        SSCC_PRINT(",\n");
    }
    ...
    void SSCC_TOLUA_FUNC(lua_State *sscc_L, int sscc_index) override {
        ...
        lua_pushlstring(sscc_L, "appearance_id", 13);
        lua_pushinteger(sscc_L, (lua_Integer)this->appearance_id);
    ...
    bool SSCC_FROMLUA_FUNC(lua_State *sscc_L, int sscc_index SSCC_FROMLUA_PARAM_DECL) override {
        ...
        if (!lua_isnil(sscc_L, -1)) {
            do {
                int isnum;
                this->appearance_id = lua_tointegerx(sscc_L, -1, &isnum);
                if (!isnum) {
                    goto sscc_exit;
                }
            } while (0);
...
struct CL_AppearanceRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_AppearanceRsp";
    static constexpr int the_message_id = CL_APPEARANCE;
    static constexpr const char *the_message_name = "CL_APPEARANCE";
    typedef CL_Appearance the_message_type;
    
    CL_AppearanceRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_Appearance {
    static constexpr const char *the_class_name = "CL_Appearance";
    static constexpr int the_message_id = CL_APPEARANCE;
    static constexpr const char *the_message_name = "CL_APPEARANCE";
    typedef CL_AppearanceReq request_type;
    typedef CL_AppearanceRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_Appearance(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
