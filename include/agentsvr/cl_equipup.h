...
#include "message.h"
struct CL_EquipUp;
struct CL_EquipUpReq : INotify {
    static constexpr const char *the_class_name = "CL_EquipUpReq";
    static constexpr int the_message_id = CL_EQUIPUP;
    static constexpr const char *the_message_name = "CL_EQUIPUP";
    typedef CL_EquipUp the_message_type;
    SSCC_UINT32 item_id;
    SSCC_UINT8 count;
    
    CL_EquipUpReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_EquipUpRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_EquipUpRsp";
    static constexpr int the_message_id = CL_EQUIPUP;
    static constexpr const char *the_message_name = "CL_EQUIPUP";
    typedef CL_EquipUp the_message_type;
    
    CL_EquipUpRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_EquipUp {
    static constexpr const char *the_class_name = "CL_EquipUp";
    static constexpr int the_message_id = CL_EQUIPUP;
    static constexpr const char *the_message_name = "CL_EQUIPUP";
    typedef CL_EquipUpReq request_type;
    typedef CL_EquipUpRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_EquipUp(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
