...
#include "message.h"
struct CL_Train;
struct CL_TrainReq : INotify {
    static constexpr const char *the_class_name = "CL_TrainReq";
    static constexpr int the_message_id = CL_TRAIN;
    static constexpr const char *the_message_name = "CL_TRAIN";
    typedef CL_Train the_message_type;
    SSCC_UINT32 sid;
    SSCC_UINT8 type;
    
    CL_TrainReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_TrainRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_TrainRsp";
    static constexpr int the_message_id = CL_TRAIN;
    static constexpr const char *the_message_name = "CL_TRAIN";
    typedef CL_Train the_message_type;
    
    CL_TrainRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_Train {
    static constexpr const char *the_class_name = "CL_Train";
    static constexpr int the_message_id = CL_TRAIN;
    static constexpr const char *the_message_name = "CL_TRAIN";
    typedef CL_TrainReq request_type;
    typedef CL_TrainRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_Train(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
struct CL_TrainCancel;
struct CL_TrainCancelReq : INotify {
    static constexpr const char *the_class_name = "CL_TrainCancelReq";
    static constexpr int the_message_id = CL_TRAIN_CANCEL;
    static constexpr const char *the_message_name = "CL_TRAIN_CANCEL";
    typedef CL_TrainCancel the_message_type;
    SSCC_UINT32 sid;
    
    CL_TrainCancelReq(SSCC_ALLOCATOR_PARAM_DECL)
    : INotify(SSCC_ALLOCATOR_PARAM),
      sid()
    { }
...
struct CL_TrainCancelRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_TrainCancelRsp";
    static constexpr int the_message_id = CL_TRAIN_CANCEL;
    static constexpr const char *the_message_name = "CL_TRAIN_CANCEL";
    typedef CL_TrainCancel the_message_type;
    
    CL_TrainCancelRsp(SSCC_ALLOCATOR_PARAM_DECL)
    : SSCC_RESPONSE_BASE(SSCC_ALLOCATOR_PARAM)
    { }
...
struct CL_TrainCancel {
    static constexpr const char *the_class_name = "CL_TrainCancel";
    static constexpr int the_message_id = CL_TRAIN_CANCEL;
    static constexpr const char *the_message_name = "CL_TRAIN_CANCEL";
    typedef CL_TrainCancelReq request_type;
    typedef CL_TrainCancelRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_TrainCancel(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
