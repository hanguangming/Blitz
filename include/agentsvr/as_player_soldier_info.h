...
#include "message.h"
struct G_PlayerSoldierItem : SSCC_DEFAULT_BASE {
    static constexpr const char *the_class_name = "G_PlayerSoldierItem";
    SSCC_UINT32 id;
    SSCC_UINT16 level;
    
    G_PlayerSoldierItem(SSCC_ALLOCATOR_PARAM_DECL)
...
struct AS_PlayerSoldierInfo;
struct AS_PlayerSoldierInfoReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "AS_PlayerSoldierInfoReq";
    static constexpr int the_message_id = AS_PLAYER_SOLDIER_INFO;
    static constexpr const char *the_message_name = "AS_PLAYER_SOLDIER_INFO";
    typedef AS_PlayerSoldierInfo the_message_type;
    
    AS_PlayerSoldierInfoReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct AS_PlayerSoldierInfoRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "AS_PlayerSoldierInfoRsp";
    static constexpr int the_message_id = AS_PLAYER_SOLDIER_INFO;
    static constexpr const char *the_message_name = "AS_PLAYER_SOLDIER_INFO";
    typedef AS_PlayerSoldierInfo the_message_type;
    SSCC_VECTOR(G_PlayerSoldierItem) list;
    
    AS_PlayerSoldierInfoRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct AS_PlayerSoldierInfo {
    static constexpr const char *the_class_name = "AS_PlayerSoldierInfo";
    static constexpr int the_message_id = AS_PLAYER_SOLDIER_INFO;
    static constexpr const char *the_message_name = "AS_PLAYER_SOLDIER_INFO";
    typedef AS_PlayerSoldierInfoReq request_type;
    typedef AS_PlayerSoldierInfoRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    AS_PlayerSoldierInfo(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
