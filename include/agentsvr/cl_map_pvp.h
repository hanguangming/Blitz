...
#include "message.h"
struct CL_MapPvp;
struct CL_MapPvpReq : INotify {
    static constexpr const char *the_class_name = "CL_MapPvpReq";
    static constexpr int the_message_id = CL_MAP_PVP;
    static constexpr const char *the_message_name = "CL_MAP_PVP";
    typedef CL_MapPvp the_message_type;
    
    CL_MapPvpReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_MapPvpRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_MapPvpRsp";
    static constexpr int the_message_id = CL_MAP_PVP;
    static constexpr const char *the_message_name = "CL_MAP_PVP";
    typedef CL_MapPvp the_message_type;
    
    CL_MapPvpRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_MapPvp {
    static constexpr const char *the_class_name = "CL_MapPvp";
    static constexpr int the_message_id = CL_MAP_PVP;
    static constexpr const char *the_message_name = "CL_MAP_PVP";
    typedef CL_MapPvpReq request_type;
    typedef CL_MapPvpRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_MapPvp(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
