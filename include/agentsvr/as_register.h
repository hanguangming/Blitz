...
#include "message.h"
struct AS_Register;
struct AS_RegisterReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "AS_RegisterReq";
    static constexpr int the_message_id = AS_REGISTER;
    static constexpr const char *the_message_name = "AS_REGISTER";
    typedef AS_Register the_message_type;
    
    AS_RegisterReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct AS_RegisterRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "AS_RegisterRsp";
    static constexpr int the_message_id = AS_REGISTER;
    static constexpr const char *the_message_name = "AS_REGISTER";
    typedef AS_Register the_message_type;
    
    AS_RegisterRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct AS_Register {
    static constexpr const char *the_class_name = "AS_Register";
    static constexpr int the_message_id = AS_REGISTER;
    static constexpr const char *the_message_name = "AS_REGISTER";
    typedef AS_RegisterReq request_type;
    typedef AS_RegisterRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    AS_Register(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
