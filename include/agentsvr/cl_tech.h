...
#include "message.h"
struct CL_TechResearch;
struct CL_TechResearchReq : INotify {
    static constexpr const char *the_class_name = "CL_TechResearchReq";
    static constexpr int the_message_id = CL_TECH_RESEARCH;
    static constexpr const char *the_message_name = "CL_TECH_RESEARCH";
    typedef CL_TechResearch the_message_type;
    SSCC_UINT32 id;
    
    CL_TechResearchReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_TechResearchRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_TechResearchRsp";
    static constexpr int the_message_id = CL_TECH_RESEARCH;
    static constexpr const char *the_message_name = "CL_TECH_RESEARCH";
    typedef CL_TechResearch the_message_type;
    
    CL_TechResearchRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_TechResearch {
    static constexpr const char *the_class_name = "CL_TechResearch";
    static constexpr int the_message_id = CL_TECH_RESEARCH;
    static constexpr const char *the_message_name = "CL_TECH_RESEARCH";
    typedef CL_TechResearchReq request_type;
    typedef CL_TechResearchRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_TechResearch(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
