...
#include "message.h"
struct CL_Move;
struct CL_MoveReq : INotify {
    static constexpr const char *the_class_name = "CL_MoveReq";
    static constexpr int the_message_id = CL_MOVE;
    static constexpr const char *the_message_name = "CL_MOVE";
    typedef CL_Move the_message_type;
    SSCC_UINT8 type;
    SSCC_VECTOR(SSCC_UINT32) path;
    
    CL_MoveReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_MoveRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_MoveRsp";
    static constexpr int the_message_id = CL_MOVE;
    static constexpr const char *the_message_name = "CL_MOVE";
    typedef CL_Move the_message_type;
    
    CL_MoveRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_Move {
    static constexpr const char *the_class_name = "CL_Move";
    static constexpr int the_message_id = CL_MOVE;
    static constexpr const char *the_message_name = "CL_MOVE";
    typedef CL_MoveReq request_type;
    typedef CL_MoveRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_Move(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
