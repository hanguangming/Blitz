...
#include "message.h"
struct CL_Supplement;
struct CL_SupplementReq : INotify {
    static constexpr const char *the_class_name = "CL_SupplementReq";
    static constexpr int the_message_id = CL_SUPPLEMENT;
    static constexpr const char *the_message_name = "CL_SUPPLEMENT";
    typedef CL_Supplement the_message_type;
    
    CL_SupplementReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_SupplementRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_SupplementRsp";
    static constexpr int the_message_id = CL_SUPPLEMENT;
    static constexpr const char *the_message_name = "CL_SUPPLEMENT";
    typedef CL_Supplement the_message_type;
    SSCC_UINT32 people;
    
    CL_SupplementRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_Supplement {
    static constexpr const char *the_class_name = "CL_Supplement";
    static constexpr int the_message_id = CL_SUPPLEMENT;
    static constexpr const char *the_message_name = "CL_SUPPLEMENT";
    typedef CL_SupplementReq request_type;
    typedef CL_SupplementRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_Supplement(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
