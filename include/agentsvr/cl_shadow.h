...
#include "message.h"
struct CL_Shadow;
struct CL_ShadowReq : INotify {
    static constexpr const char *the_class_name = "CL_ShadowReq";
    static constexpr int the_message_id = CL_SHADOW;
    static constexpr const char *the_message_name = "CL_SHADOW";
    typedef CL_Shadow the_message_type;
    
    CL_ShadowReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_ShadowRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_ShadowRsp";
    static constexpr int the_message_id = CL_SHADOW;
    static constexpr const char *the_message_name = "CL_SHADOW";
    typedef CL_Shadow the_message_type;
    
    CL_ShadowRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_Shadow {
    static constexpr const char *the_class_name = "CL_Shadow";
    static constexpr int the_message_id = CL_SHADOW;
    static constexpr const char *the_message_name = "CL_SHADOW";
    typedef CL_ShadowReq request_type;
    typedef CL_ShadowRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_Shadow(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
