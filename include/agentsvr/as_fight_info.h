...
#include "message.h"
struct AS_FightInfo;
struct AS_FightInfoReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "AS_FightInfoReq";
    static constexpr int the_message_id = AS_FIGHT_INFO;
    static constexpr const char *the_message_name = "AS_FIGHT_INFO";
    typedef AS_FightInfo the_message_type;
    SSCC_UINT8 formation;
    
    AS_FightInfoReq(SSCC_ALLOCATOR_PARAM_DECL)
    ...
    bool SSCC_SERIAL_FUNC(SSCC_SERIAL_PARAM_DECL) const override {
        ...
        SSCC_WRITE_UINT8(this->formation);
        return true;
    }
    ...
    bool SSCC_UNSERIAL_FUNC(SSCC_UNSERIAL_PARAM_DECL) override {
        ...
        SSCC_READ_UINT8(this->formation);
        return true;
    }
    ...
    void SSCC_DUMP_FUNC(unsigned sscc_indent SSCC_DUMP_PARAM_DECL) override {
        ...
        SSCC_PRINT("formation = ");
        SSCC_PRINT("%u(0x%x)", (unsigned)this->formation, (unsigned)this->formation);
        SSCC_PRINT(",\n");
    }
    ...
    void SSCC_TOLUA_FUNC(lua_State *sscc_L, int sscc_index) override {
        ...
        lua_pushlstring(sscc_L, "formation", 9);
        lua_pushinteger(sscc_L, (lua_Integer)this->formation);
    ...
    bool SSCC_FROMLUA_FUNC(lua_State *sscc_L, int sscc_index SSCC_FROMLUA_PARAM_DECL) override {
        ...
        if (!lua_isnil(sscc_L, -1)) {
            do {
                int isnum;
                this->formation = lua_tointegerx(sscc_L, -1, &isnum);
                if (!isnum) {
                    goto sscc_exit;
                }
            } while (0);
...
struct AS_FightInfoRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "AS_FightInfoRsp";
    static constexpr int the_message_id = AS_FIGHT_INFO;
    static constexpr const char *the_message_name = "AS_FIGHT_INFO";
    typedef AS_FightInfo the_message_type;
    G_FightCorps info;
    
    AS_FightInfoRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct AS_FightInfo {
    static constexpr const char *the_class_name = "AS_FightInfo";
    static constexpr int the_message_id = AS_FIGHT_INFO;
    static constexpr const char *the_message_name = "AS_FIGHT_INFO";
    typedef AS_FightInfoReq request_type;
    typedef AS_FightInfoRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    AS_FightInfo(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
