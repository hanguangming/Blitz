...
#include "message.h"
struct CL_MapSubscribe;
struct CL_MapSubscribeReq : INotify {
    static constexpr const char *the_class_name = "CL_MapSubscribeReq";
    static constexpr int the_message_id = CL_MAP_SUBSCRIBE;
    static constexpr const char *the_message_name = "CL_MAP_SUBSCRIBE";
    typedef CL_MapSubscribe the_message_type;
    SSCC_UINT32 city;
    
    CL_MapSubscribeReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_MapSubscribeRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "CL_MapSubscribeRsp";
    static constexpr int the_message_id = CL_MAP_SUBSCRIBE;
    static constexpr const char *the_message_name = "CL_MAP_SUBSCRIBE";
    typedef CL_MapSubscribe the_message_type;
    
    CL_MapSubscribeRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct CL_MapSubscribe {
    static constexpr const char *the_class_name = "CL_MapSubscribe";
    static constexpr int the_message_id = CL_MAP_SUBSCRIBE;
    static constexpr const char *the_message_name = "CL_MAP_SUBSCRIBE";
    typedef CL_MapSubscribeReq request_type;
    typedef CL_MapSubscribeRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    CL_MapSubscribe(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
