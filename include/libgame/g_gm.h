...
#include "message.h"
struct GM_UpdateTime;
struct GM_UpdateTimeReq : INotify {
    static constexpr const char *the_class_name = "GM_UpdateTimeReq";
    static constexpr int the_message_id = GM_UPDATE_TIME;
    static constexpr const char *the_message_name = "GM_UPDATE_TIME";
    typedef GM_UpdateTime the_message_type;
    SSCC_UINT64 time;
    
    GM_UpdateTimeReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct GM_UpdateTime {
    static constexpr const char *the_class_name = "GM_UpdateTime";
    static constexpr int the_message_id = GM_UPDATE_TIME;
    static constexpr const char *the_message_name = "GM_UPDATE_TIME";
    typedef GM_UpdateTimeReq request_type;
    typedef void response_type;
    
    SSCC_POINTER(request_type) req;
    
    GM_UpdateTime(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)) { }
};
struct GM_Shutdown;
struct GM_ShutdownReq : INotify {
    static constexpr const char *the_class_name = "GM_ShutdownReq";
    static constexpr int the_message_id = GM_SHUTDOWN;
    static constexpr const char *the_message_name = "GM_SHUTDOWN";
    typedef GM_Shutdown the_message_type;
    
    GM_ShutdownReq(SSCC_ALLOCATOR_PARAM_DECL)
    : INotify(SSCC_ALLOCATOR_PARAM)
    { }
...
struct GM_Shutdown {
    static constexpr const char *the_class_name = "GM_Shutdown";
    static constexpr int the_message_id = GM_SHUTDOWN;
    static constexpr const char *the_message_name = "GM_SHUTDOWN";
    typedef GM_ShutdownReq request_type;
    typedef void response_type;
    
    SSCC_POINTER(request_type) req;
    
    GM_Shutdown(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)) { }
};
