...
#include "message.h"
struct FS_Fight;
struct FS_FightReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "FS_FightReq";
    static constexpr int the_message_id = FS_FIGHT;
    static constexpr const char *the_message_name = "FS_FIGHT";
    typedef FS_Fight the_message_type;
    G_FightInfo info;
    
    FS_FightReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct FS_FightRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "FS_FightRsp";
    static constexpr int the_message_id = FS_FIGHT;
    static constexpr const char *the_message_name = "FS_FIGHT";
    typedef FS_Fight the_message_type;
    G_FightInfo info;
    
    FS_FightRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct FS_Fight {
    static constexpr const char *the_class_name = "FS_Fight";
    static constexpr int the_message_id = FS_FIGHT;
    static constexpr const char *the_message_name = "FS_FIGHT";
    typedef FS_FightReq request_type;
    typedef FS_FightRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    FS_Fight(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
