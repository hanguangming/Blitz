...
#include "message.h"
struct DB_Recast;
struct DB_RecastReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_RecastReq";
    static constexpr int the_message_id = DB_RECAST;
    static constexpr const char *the_message_name = "DB_RECAST";
    typedef DB_Recast the_message_type;
    SSCC_VECTOR(G_ValueOpt) value_opts;
    SSCC_VECTOR(G_BagItemOpt) item_opts;
    
    DB_RecastReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_RecastRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_RecastRsp";
    static constexpr int the_message_id = DB_RECAST;
    static constexpr const char *the_message_name = "DB_RECAST";
    typedef DB_Recast the_message_type;
    
    DB_RecastRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_Recast {
    static constexpr const char *the_class_name = "DB_Recast";
    static constexpr int the_message_id = DB_RECAST;
    static constexpr const char *the_message_name = "DB_RECAST";
    typedef DB_RecastReq request_type;
    typedef DB_RecastRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_Recast(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
