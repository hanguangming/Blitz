...
#include "message.h"
struct DB_Recruit;
struct DB_RecruitReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_RecruitReq";
    static constexpr int the_message_id = DB_RECRUIT;
    static constexpr const char *the_message_name = "DB_RECRUIT";
    typedef DB_Recruit the_message_type;
    SSCC_VECTOR(G_ValueOpt) value_opts;
    SSCC_VECTOR(G_BagItemOpt) item_opts;
    SSCC_VECTOR(G_ExpireOpt) cd_opts;
    
    DB_RecruitReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_RecruitRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_RecruitRsp";
    static constexpr int the_message_id = DB_RECRUIT;
    static constexpr const char *the_message_name = "DB_RECRUIT";
    typedef DB_Recruit the_message_type;
    
    DB_RecruitRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_Recruit {
    static constexpr const char *the_class_name = "DB_Recruit";
    static constexpr int the_message_id = DB_RECRUIT;
    static constexpr const char *the_message_name = "DB_RECRUIT";
    typedef DB_RecruitReq request_type;
    typedef DB_RecruitRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_Recruit(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
