...
#include "message.h"
struct DB_Recharge;
struct DB_RechargeReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_RechargeReq";
    static constexpr int the_message_id = DB_RECHARGE;
    static constexpr const char *the_message_name = "DB_RECHARGE";
    typedef DB_Recharge the_message_type;
    SSCC_VECTOR(G_ValueOpt) value_opts;
    
    DB_RechargeReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_RechargeRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_RechargeRsp";
    static constexpr int the_message_id = DB_RECHARGE;
    static constexpr const char *the_message_name = "DB_RECHARGE";
    typedef DB_Recharge the_message_type;
    
    DB_RechargeRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_Recharge {
    static constexpr const char *the_class_name = "DB_Recharge";
    static constexpr int the_message_id = DB_RECHARGE;
    static constexpr const char *the_message_name = "DB_RECHARGE";
    typedef DB_RechargeReq request_type;
    typedef DB_RechargeRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_Recharge(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
