...
#include "message.h"
struct DB_UseEquip;
struct DB_UseEquipReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_UseEquipReq";
    static constexpr int the_message_id = DB_USE_EQUIP;
    static constexpr const char *the_message_name = "DB_USE_EQUIP";
    typedef DB_UseEquip the_message_type;
    SSCC_VECTOR(G_BagItemOpt) item_opts;
    SSCC_VECTOR(G_SoldierValueOpt) value_opts;
    
    DB_UseEquipReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_UseEquipRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_UseEquipRsp";
    static constexpr int the_message_id = DB_USE_EQUIP;
    static constexpr const char *the_message_name = "DB_USE_EQUIP";
    typedef DB_UseEquip the_message_type;
    
    DB_UseEquipRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_UseEquip {
    static constexpr const char *the_class_name = "DB_UseEquip";
    static constexpr int the_message_id = DB_USE_EQUIP;
    static constexpr const char *the_message_name = "DB_USE_EQUIP";
    typedef DB_UseEquipReq request_type;
    typedef DB_UseEquipRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_UseEquip(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
