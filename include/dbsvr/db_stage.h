...
#include "message.h"
struct DB_Stage;
struct DB_StageReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_StageReq";
    static constexpr int the_message_id = DB_STAGE;
    static constexpr const char *the_message_name = "DB_STAGE";
    typedef DB_Stage the_message_type;
    SSCC_VECTOR(G_ValueOpt) value_opts;
    SSCC_VECTOR(G_BagItemOpt) item_opts;
    
    DB_StageReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_StageRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_StageRsp";
    static constexpr int the_message_id = DB_STAGE;
    static constexpr const char *the_message_name = "DB_STAGE";
    typedef DB_Stage the_message_type;
    
    DB_StageRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_Stage {
    static constexpr const char *the_class_name = "DB_Stage";
    static constexpr int the_message_id = DB_STAGE;
    static constexpr const char *the_message_name = "DB_STAGE";
    typedef DB_StageReq request_type;
    typedef DB_StageRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_Stage(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
