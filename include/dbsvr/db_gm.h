...
#include "message.h"
struct DB_GMValueItem;
struct DB_GMValueItemReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_GMValueItemReq";
    static constexpr int the_message_id = DB_GM_VALUE_ITEM;
    static constexpr const char *the_message_name = "DB_GM_VALUE_ITEM";
    typedef DB_GMValueItem the_message_type;
    SSCC_VECTOR(G_BagItemOpt) item_opts;
    SSCC_VECTOR(G_ValueOpt) value_opts;
    
    DB_GMValueItemReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_GMValueItemRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_GMValueItemRsp";
    static constexpr int the_message_id = DB_GM_VALUE_ITEM;
    static constexpr const char *the_message_name = "DB_GM_VALUE_ITEM";
    typedef DB_GMValueItem the_message_type;
    
    DB_GMValueItemRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_GMValueItem {
    static constexpr const char *the_class_name = "DB_GMValueItem";
    static constexpr int the_message_id = DB_GM_VALUE_ITEM;
    static constexpr const char *the_message_name = "DB_GM_VALUE_ITEM";
    typedef DB_GMValueItemReq request_type;
    typedef DB_GMValueItemRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_GMValueItem(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
