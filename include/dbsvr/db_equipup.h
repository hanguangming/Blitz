...
#include "message.h"
struct DB_EquipUp;
struct DB_EquipUpReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_EquipUpReq";
    static constexpr int the_message_id = DB_EQUIPUP;
    static constexpr const char *the_message_name = "DB_EQUIPUP";
    typedef DB_EquipUp the_message_type;
    SSCC_VECTOR(G_ValueOpt) value_opts;
    SSCC_VECTOR(G_BagItemOpt) item_opts;
    
    DB_EquipUpReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_EquipUpRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_EquipUpRsp";
    static constexpr int the_message_id = DB_EQUIPUP;
    static constexpr const char *the_message_name = "DB_EQUIPUP";
    typedef DB_EquipUp the_message_type;
    
    DB_EquipUpRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_EquipUp {
    static constexpr const char *the_class_name = "DB_EquipUp";
    static constexpr int the_message_id = DB_EQUIPUP;
    static constexpr const char *the_message_name = "DB_EQUIPUP";
    typedef DB_EquipUpReq request_type;
    typedef DB_EquipUpRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_EquipUp(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
