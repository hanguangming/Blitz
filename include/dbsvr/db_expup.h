...
#include "message.h"
struct DB_ExpUp;
struct DB_ExpUpReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_ExpUpReq";
    static constexpr int the_message_id = DB_EXP_UP;
    static constexpr const char *the_message_name = "DB_EXP_UP";
    typedef DB_ExpUp the_message_type;
    SSCC_VECTOR(G_BagItemOpt) item_opts;
    SSCC_VECTOR(G_SoldierValueOpt) value_opts;
    
    DB_ExpUpReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_ExpUpRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_ExpUpRsp";
    static constexpr int the_message_id = DB_EXP_UP;
    static constexpr const char *the_message_name = "DB_EXP_UP";
    typedef DB_ExpUp the_message_type;
    
    DB_ExpUpRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_ExpUp {
    static constexpr const char *the_class_name = "DB_ExpUp";
    static constexpr int the_message_id = DB_EXP_UP;
    static constexpr const char *the_message_name = "DB_EXP_UP";
    typedef DB_ExpUpReq request_type;
    typedef DB_ExpUpRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_ExpUp(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
