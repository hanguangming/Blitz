...
#include "message.h"
struct DB_Sell;
struct DB_SellReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_SellReq";
    static constexpr int the_message_id = DB_SELL;
    static constexpr const char *the_message_name = "DB_SELL";
    typedef DB_Sell the_message_type;
    SSCC_VECTOR(G_BagItemOpt) item_opts;
    SSCC_VECTOR(G_ValueOpt) value_opts;
    
    DB_SellReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_SellRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_SellRsp";
    static constexpr int the_message_id = DB_SELL;
    static constexpr const char *the_message_name = "DB_SELL";
    typedef DB_Sell the_message_type;
    
    DB_SellRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_Sell {
    static constexpr const char *the_class_name = "DB_Sell";
    static constexpr int the_message_id = DB_SELL;
    static constexpr const char *the_message_name = "DB_SELL";
    typedef DB_SellReq request_type;
    typedef DB_SellRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_Sell(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
