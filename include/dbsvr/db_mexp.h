...
#include "message.h"
struct DB_MExp;
struct DB_MExpReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_MExpReq";
    static constexpr int the_message_id = DB_MEXP;
    static constexpr const char *the_message_name = "DB_MEXP";
    typedef DB_MExp the_message_type;
    SSCC_VECTOR(G_ValueOpt) value_opts;
    
    DB_MExpReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_MExpRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_MExpRsp";
    static constexpr int the_message_id = DB_MEXP;
    static constexpr const char *the_message_name = "DB_MEXP";
    typedef DB_MExp the_message_type;
    
    DB_MExpRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_MExp {
    static constexpr const char *the_class_name = "DB_MExp";
    static constexpr int the_message_id = DB_MEXP;
    static constexpr const char *the_message_name = "DB_MEXP";
    typedef DB_MExpReq request_type;
    typedef DB_MExpRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_MExp(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
