...
#include "message.h"
struct DB_UseHero;
struct DB_UseHeroReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_UseHeroReq";
    static constexpr int the_message_id = DB_USE_HERO;
    static constexpr const char *the_message_name = "DB_USE_HERO";
    typedef DB_UseHero the_message_type;
    SSCC_VECTOR(G_SoldierValueOpt) value_opts;
    
    DB_UseHeroReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_UseHeroRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_UseHeroRsp";
    static constexpr int the_message_id = DB_USE_HERO;
    static constexpr const char *the_message_name = "DB_USE_HERO";
    typedef DB_UseHero the_message_type;
    
    DB_UseHeroRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_UseHero {
    static constexpr const char *the_class_name = "DB_UseHero";
    static constexpr int the_message_id = DB_USE_HERO;
    static constexpr const char *the_message_name = "DB_USE_HERO";
    typedef DB_UseHeroReq request_type;
    typedef DB_UseHeroRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_UseHero(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
