...
#include "message.h"
struct DB_FormationSave;
struct DB_FormationSaveReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_FormationSaveReq";
    static constexpr int the_message_id = DB_FORMATION_SAVE;
    static constexpr const char *the_message_name = "DB_FORMATION_SAVE";
    typedef DB_FormationSave the_message_type;
    SSCC_VECTOR(G_FormationOpt) formations;
    
    DB_FormationSaveReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_FormationSaveRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_FormationSaveRsp";
    static constexpr int the_message_id = DB_FORMATION_SAVE;
    static constexpr const char *the_message_name = "DB_FORMATION_SAVE";
    typedef DB_FormationSave the_message_type;
    
    DB_FormationSaveRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_FormationSave {
    static constexpr const char *the_class_name = "DB_FormationSave";
    static constexpr int the_message_id = DB_FORMATION_SAVE;
    static constexpr const char *the_message_name = "DB_FORMATION_SAVE";
    typedef DB_FormationSaveReq request_type;
    typedef DB_FormationSaveRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_FormationSave(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
struct DB_FormationUse;
struct DB_FormationUseReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_FormationUseReq";
    static constexpr int the_message_id = DB_FORMATION_USE;
    static constexpr const char *the_message_name = "DB_FORMATION_USE";
    typedef DB_FormationUse the_message_type;
    SSCC_VECTOR(G_ValueOpt) value_opts;
    
    DB_FormationUseReq(SSCC_ALLOCATOR_PARAM_DECL)
    : SSCC_REQUEST_BASE(SSCC_ALLOCATOR_PARAM),
...
struct DB_FormationUseRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_FormationUseRsp";
    static constexpr int the_message_id = DB_FORMATION_USE;
    static constexpr const char *the_message_name = "DB_FORMATION_USE";
    typedef DB_FormationUse the_message_type;
    
    DB_FormationUseRsp(SSCC_ALLOCATOR_PARAM_DECL)
    : SSCC_RESPONSE_BASE(SSCC_ALLOCATOR_PARAM)
    { }
...
struct DB_FormationUse {
    static constexpr const char *the_class_name = "DB_FormationUse";
    static constexpr int the_message_id = DB_FORMATION_USE;
    static constexpr const char *the_message_name = "DB_FORMATION_USE";
    typedef DB_FormationUseReq request_type;
    typedef DB_FormationUseRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_FormationUse(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
