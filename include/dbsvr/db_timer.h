...
#include "message.h"
struct DB_AgentTimer;
struct DB_AgentTimerReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_AgentTimerReq";
    static constexpr int the_message_id = DB_AGENT_TIMER;
    static constexpr const char *the_message_name = "DB_AGENT_TIMER";
    typedef DB_AgentTimer the_message_type;
    SSCC_VECTOR(G_ValueOpt) value_opts;
    
    DB_AgentTimerReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_AgentTimerRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_AgentTimerRsp";
    static constexpr int the_message_id = DB_AGENT_TIMER;
    static constexpr const char *the_message_name = "DB_AGENT_TIMER";
    typedef DB_AgentTimer the_message_type;
    
    DB_AgentTimerRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_AgentTimer {
    static constexpr const char *the_class_name = "DB_AgentTimer";
    static constexpr int the_message_id = DB_AGENT_TIMER;
    static constexpr const char *the_message_name = "DB_AGENT_TIMER";
    typedef DB_AgentTimerReq request_type;
    typedef DB_AgentTimerRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_AgentTimer(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
