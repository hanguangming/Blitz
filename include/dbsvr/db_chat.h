...
#include "message.h"
struct DB_Chat;
struct DB_ChatReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_ChatReq";
    static constexpr int the_message_id = DB_CHAT;
    static constexpr const char *the_message_name = "DB_CHAT";
    typedef DB_Chat the_message_type;
    SSCC_VECTOR(G_ValueOpt) value_opts;
    
    DB_ChatReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_ChatRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_ChatRsp";
    static constexpr int the_message_id = DB_CHAT;
    static constexpr const char *the_message_name = "DB_CHAT";
    typedef DB_Chat the_message_type;
    
    DB_ChatRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_Chat {
    static constexpr const char *the_class_name = "DB_Chat";
    static constexpr int the_message_id = DB_CHAT;
    static constexpr const char *the_message_name = "DB_CHAT";
    typedef DB_ChatReq request_type;
    typedef DB_ChatRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_Chat(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
