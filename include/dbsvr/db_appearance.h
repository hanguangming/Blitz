...
struct DB_AppearanceReq : SSCC_REQUEST_BASE {
    ...
    static constexpr const char *the_message_name = "DB_APPEARANCE";
    typedef DB_Appearance the_message_type;
    SSCC_VECTOR(G_ValueOpt) value_opts;
    
    DB_AppearanceReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_AppearanceRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_AppearanceRsp";
    static constexpr int the_message_id = DB_APPEARANCE;
    static constexpr const char *the_message_name = "DB_APPEARANCE";
    typedef DB_Appearance the_message_type;
    
    DB_AppearanceRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_Appearance {
    static constexpr const char *the_class_name = "DB_Appearance";
    static constexpr int the_message_id = DB_APPEARANCE;
    static constexpr const char *the_message_name = "DB_APPEARANCE";
    typedef DB_AppearanceReq request_type;
    typedef DB_AppearanceRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_Appearance(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
