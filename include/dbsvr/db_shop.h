...
#include "message.h"
struct DB_ShopBuy;
struct DB_ShopBuyReq : SSCC_REQUEST_BASE {
    static constexpr const char *the_class_name = "DB_ShopBuyReq";
    static constexpr int the_message_id = DB_SHOP_BUY;
    static constexpr const char *the_message_name = "DB_SHOP_BUY";
    typedef DB_ShopBuy the_message_type;
    SSCC_VECTOR(G_BagItemOpt) item_opts;
    SSCC_VECTOR(G_ValueOpt) value_opts;
    SSCC_VECTOR(G_SoldierValueOpt) soldier_value_opts;
    
    DB_ShopBuyReq(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_ShopBuyRsp : SSCC_RESPONSE_BASE {
    static constexpr const char *the_class_name = "DB_ShopBuyRsp";
    static constexpr int the_message_id = DB_SHOP_BUY;
    static constexpr const char *the_message_name = "DB_SHOP_BUY";
    typedef DB_ShopBuy the_message_type;
    
    DB_ShopBuyRsp(SSCC_ALLOCATOR_PARAM_DECL)
...
struct DB_ShopBuy {
    static constexpr const char *the_class_name = "DB_ShopBuy";
    static constexpr int the_message_id = DB_SHOP_BUY;
    static constexpr const char *the_message_name = "DB_SHOP_BUY";
    typedef DB_ShopBuyReq request_type;
    typedef DB_ShopBuyRsp response_type;
    
    SSCC_POINTER(request_type) req;
    SSCC_POINTER(response_type) rsp;
    
    DB_ShopBuy(SSCC_MESSAGE_PARAM_DECL) : req(SSCC_CREATE(request_type)), rsp() { }
};
